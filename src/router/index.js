...
export const asyncRouterMap = [

 {
    ...
    hidden:false,
    children: [
     {path: '/dashboard',name: '工作台',icon:'speedometer',component: _import('Dashboard')},
     {path: '/introduction',name: '介绍',icon:'thumbsup',component: _import('Introduction')},
     {path: '/components',name: '车辆中心',redirect: '/components/buttons',icon:'bookmark',
       ...
       {path: '/charts',name: '车辆信息',redirect: '/charts/shopchart',icon:'pie-graph',
        component: {render (c) { return c('router-view') }},
      ...
      {path: '/table', name: '货源管理',icon:'ios-paper',component: _import('Table'),meta: { role: ['admin'] }},
      {path: '/jsontree', name: '订单管理',icon:'merge',component: _import('JsonTree')},
      {path: '/tabledetail/:id',name: 'TableDetail', hidden:true, component: _import('TableDetail')},
      {path: '/tinymce',name: '部门管理',icon:"android-document",component: _import('Tinymce')},
      {path: '/role',name: '角色管理',icon:"android-list",component: _import('Role')},
      {path: '/path',name: '路线管理',icon:"android-list",component: _import('Path')},
      {path: '/performance',name: '绩效考核',icon:"android-list",component: _import('Performance')},
      {path: '/finance',name: '财务统计',icon:"android-list",component: _import('Finance')},
